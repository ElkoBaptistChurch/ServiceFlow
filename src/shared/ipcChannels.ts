export const IpcChannels = {
  ...
  FindSongsByQuery: 'song:find-by-query',
  GetBlocksForSong: 'song:get-blocks',
  SearchSongContent: 'song:search-content',
  FindDuplicateSong: 'song:find-duplicate',
  CreateSong: 'song:create',
  UpdateSong: 'song:update',
  DeleteSong: 'song:delete',
  AddSongBlock: 'song:add-block',
  UpdateSongBlock: 'song:update-block',
  DeleteSongBlock: 'song:delete-block',
  ReorderSongBlocks: 'song:reorder-blocks',
